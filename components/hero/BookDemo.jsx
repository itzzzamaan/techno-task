const BookDemo = () => {
  return (
    <section className="bg-[#060606] py-8 px-8">
      <div className="max-w-6xl mx-auto border border-white/10 bg-gradient-to-br from-[#0B0B1F] to-[#1B012A] rounded-2xl text-center px-6 py-22 shadow-lg relative overflow-hidden">
