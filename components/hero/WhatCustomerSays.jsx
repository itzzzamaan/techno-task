...
export default function WhatCustomerSays() {
  ...
  return (
    <section className="bg-[#060606] text-white px-8 py-4 pb-8">
      <div className="max-w-7xl mx-auto space-y-10">
        {/* Heading */}
        <h2 className="text-center text-3xl md:text-4xl font-light leading-tight">
          What Our{" "}
        ...
        {/* Main Card */}
        <div className="relative bg-gradient-to-br from-[#0B0B1F] to-[#1B012A] rounded-2xl p-6 md:p-12 flex flex-col md:flex-row justify-between items-center gap-10 overflow-hidden">
          {/* Left Content */}
          <div className="flex-1 z-10">
            ...
            <div className="flex gap-10">
              <div>
                <h4 className="text-purple-500 text-2xl font-bold">200+</h4>
                <p className="text-sm text-white mt-1">Projects Successfully</p>
              </div>
              <div>
                <h4 className="text-purple-500 text-2xl font-bold">600+</h4>
                <p className="text-sm text-white mt-1">Projects Successfully</p>
              </div>
            </div>
          </div>
          ...
          {/* Testimonial Card */}
          <div className="relative w-full max-w-lg h-[65vh] z-10">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-gradient-to-br from-[#3F2AB2] ml-10   via-[#9333ea] to-[#B462CE]  text-white p-6 rounded-xl max-w-sm z-10 shadow-xl"
              >
            ...
            <div className="absolute  -top-16 inset-0 flex justify-center items-center -z-10">
