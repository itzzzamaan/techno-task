...
import { Brain, MessageSquare, Volume2, ClipboardCheck, Bell, Zap, BarChart3, Shield, Globe, Heart, Mic, TrendingUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Automatically detect and analyze conversations in 40+ languages with 99.8% accuracy. Real-time language switching and seamless multilingual support.",
      stats: "40+",
    ...
    },
    {
      ...
      description: "Deep emotional intelligence that understands context, tone, and sentiment. Track customer satisfaction and agent performance in real-time.",
      stats: "95%",
    ...
    },
    {
      ...
      description: "Intelligent detection of awkward silences, hold times, and conversation gaps. Optimize call flow and reduce customer frustration.",
      stats: "0.5s",
    ...
    },
    {
      ...
      description: "Comprehensive call scoring based on compliance, script adherence, and customer satisfaction metrics. Real-time feedback for agents.",
      stats: "100%",
    ...
    },
    {
      ...
      description: "Immediate alerts for compliance violations, escalation triggers, and quality issues. Keep your team informed and responsive.",
      stats: "<1s",
    ...
    },
    {
      ...
      description: "Comprehensive analytics and reporting with customizable dashboards. Track KPIs, trends, and performance metrics across all channels.",
      stats: "24/7",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className={`text-center mb-16 lg:mb-24 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-4xl lg:text-6xl font-light mb-6">
            ...
            <br />
            deliver smart <span className="bg-gradient-to-r font-semibold to-[#B462CE] from-[#3F2AB2] bg-clip-text text-transparent">AI solutions</span>
          </h1>
          
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Advanced conversation intelligence that transforms every customer interaction into actionable insights
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`group relative p-6 lg:p-8 rounded-2xl border transition-all duration-700 cursor-pointer
                  ${isActive ? 'border-purple-500/50 bg-gradient-to-br from-purple-900/30 to-pink-900/20 scale-105' : 'border-gray-800 bg-gray-900/50 hover:border-gray-700'}
              ...
              >
                ...
                {/* Icon */}
                <div className={`relative w-16 h-16 mb-6 rounded-xl bg-gradient-to-br ${feature.color} p-4 shadow-lg transform transition-transform duration-300 group-hover:scale-110`}>
                  <Icon className="w-full h-full text-white" />
                </div>

                {/* Stats */}
                <div className="mb-4">
                  <div className={`text-3xl lg:text-4xl font-bold bg-gradient-to-r ${feature.color} bg-clip-text text-transparent`}>
                    {feature.stats}
                  </div>
